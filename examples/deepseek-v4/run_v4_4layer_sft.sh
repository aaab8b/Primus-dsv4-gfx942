...
#
# Usage:
#   SEQ=4096   SFT_JSONL=/apps/zhaobing/sft_data/sft_4k.jsonl   bash run_v4_4layer_sft.sh
#   SEQ=131072 SFT_JSONL=/apps/zhaobing/sft_data/sft_128k.jsonl bash run_v4_4layer_sft.sh
set -euo pipefail

cd /apps/zhaobing/Primus
...
export BACKEND_PATH=${BACKEND_PATH:-/apps/zhaobing/Primus/third_party/Megatron-LM}
export PRIMUS_OUTPUT_ROOT=${PRIMUS_OUTPUT_ROOT:-/apps/zhaobing/primus-output}
export PRIMUS_TEAM=${PRIMUS_TEAM:-amd}
export PRIMUS_USER=${PRIMUS_USER:-zhaobing}
...
export SFT_JSONL=${SFT_JSONL:-/apps/zhaobing/sft_data/sft_4k.jsonl}
export MBS=${MBS:-1}
export GBS=${GBS:-8}
